...
# ── DISCLAIMER ────────────────────────────────────────────────────────────
st.markdown(f"""
<div style="background:{C_SURFACE};border:1px solid {C_BORDER};border-left:3px solid {C_ACCENT};border-radius:8px;
padding:0.55rem 0.9rem;margin-bottom:0.9rem;font-size:0.72rem;color:{C_MUTED};line-height:1.45;">
<b style="color:{C_TEXT};">Demonstration build.</b> This is a portfolio reproduction of an
